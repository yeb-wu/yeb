...
/* import { useStore } from 'vuex' */
  export default {
    ...
    setup(){
      ...
      const handleLogin=async()=>{
        ...
        try{
          ...
          if(result?.success){
            //store.commit('change',form.nickname)登录用户名
            /* store.state.loginId=result.data.uId;
            store.state.loginPassword=form.password; */
            localStorage.loginId=result.data.uId
            localStorage.loginPassword=form.password
    ...
    return {handleLogin,form,handleRegisterClick}
    }
  }
